...
{
    internal class EventBusServiceBus : BaseEventBus
    {
        ...
        public override void Subscribe<T, TH>()
        {
            ...
            SubsManager.HasSubscriptionForEvent(eventName);
        ...
        public override void UnSubscribe<T, TH>()
        {
            ...
            logger.LogInformation("Unsubscripbing from event {eventName}", eventName);
        ...
        private void CreateRuleIfNotExist(string eventName, ISubscriptionClient subscriptionClient)
        {
            ...
            {
                //Azure management client dosn't have ruleexist method
                ruleExist = false;
            }
            if(!ruleExist)
            {
